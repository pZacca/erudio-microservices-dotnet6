    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "pedro-admin@zaccaria.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (13) 99765-5782",
                FirstName = "Pedro",
                LastName = "Admin"
            };

            _user.CreateAsync(admin, "Zaccaria123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "pedro-client@zaccaria.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (13) 99765-5782",
                FirstName = "Pedro",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Zaccaria123$").GetAwaiter().GetResult();
